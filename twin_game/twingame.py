...
class TwinGame(Qt.QMainWindow):
    ...
    def build_control_panel(self):
        ...
        start_icn = Qt.QIcon(osp.join(mypath, 'images', 'restart.png'))
        asso_icn = Qt.QIcon(osp.join(mypath, 'images', 'link.png'))
        disso_icn = Qt.QIcon(osp.join(mypath, 'images', 'unlink.png'))
        unsel_icn = Qt.QIcon(osp.join(mypath, 'images', 'unselect.png'))
        verif_icn = Qt.QIcon(osp.join(mypath, 'images', 'reveal.png'))
        mesh_icn = Qt.QIcon(osp.join(mypath, 'images', 'meshes.png'))
        sulci_icn = Qt.QIcon(osp.join(mypath, 'images', 'sulci.png'))
        sync_icn = Qt.QIcon(osp.join(mypath, 'images', 'sync.png'))
        sett_icn = Qt.QIcon(osp.join(mypath, 'images', 'settings.png'))
        quit_icn = Qt.QIcon(osp.join(mypath, 'images', 'power.png'))
